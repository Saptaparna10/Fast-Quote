...
<div id="global">
<s:form action="Accidentdelete">
<s:textfield key="accidentHistoryId" label="Enter AccidentId"></s:textfield>
<span class="error">${acciderror}</span></p>
<s:submit value="Delete"></s:submit>
</s:form>
<s:form action="MulAccDelete">

<!--<s:submit value="Multiple Delete"></s:submit>
--></s:form>
</div>
