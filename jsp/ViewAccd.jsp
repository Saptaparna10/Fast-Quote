...
Accident HistoryId : <s:property value="accidentHistoryId"/> <br>
Vehicle ID: <s:property value="FqVehicle.vehicleId"/><br>
Date Of Accident :  <s:property value="dateOfAccident"/><br>
Nature of Accident : <s:property value="natureOfAccident"/><br>
