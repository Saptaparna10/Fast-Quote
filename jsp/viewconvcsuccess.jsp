...
Conviction HistoryId : <s:property value="convictionHistoryId"/><br>
User Id : <s:property value="FqUser.userId"/><br>
Date Of Conviction :  <s:property value="dateOfConviction"/><br>
Nature of Conviction : <s:property value="natureOfConviction"/><br>
Comments : <s:property value="comments"/><br>
</s:iterator>
