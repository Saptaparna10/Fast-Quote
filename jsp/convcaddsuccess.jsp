...
<p>Conviction Details Added Successfully </p>

<jsp:useBean id="result" class="com.tcs.ilp.model.FqConvictionhistory" scope="request" />
<table>
<tr><th>Conviction Id</th><td><jsp:getProperty name="result" property="convictionHistoryId"/></td></tr>
<tr><th>User Id</th><td> ${result.fqUser.userId }</td></tr>

<tr><th>Nature Of Conviction</th><td><jsp:getProperty name="result" property="natureOfConviction"/></td></tr>
<tr><th>Date Of Conviction</th><td><jsp:getProperty name="result" property="dateOfConviction"/></td></tr>
<tr><th>Comments</th><td><jsp:getProperty name="result" property="comments"/></td></tr>
</table>
