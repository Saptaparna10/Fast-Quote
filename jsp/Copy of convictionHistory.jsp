...
<FORM  id="insuranceReg" name="insuranceReg" action="proposalAndQuoteController/ConvictionHistory" method="post">
<fieldset>
   <legend align="middle"><b> Conviction History </b></legend><br>
                                    <p><label for="USERID">User Id<font color=red size=2px> *</font> :</label>
<input type='text' placeholder="Enter the user id" name="USERID"></p>
