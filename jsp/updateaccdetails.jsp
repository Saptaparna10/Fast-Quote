...
<div id="global">
<s:form action="ConfirmAccidentupdate">
<s:textfield key="accidentHistoryId" label="AccId:" readonly="true" value="%{#request.fqbean.accidentHistoryId}"/>
...
<sj:datepicker label="Date of Accident" key="dateOfAccident" showAnim="slideDown" value="%{#request.fqbean.dateOfAccident}"></sj:datepicker>
<s:select  name="natureOfAccident"
 label="Nature of Accident"  value="%{#request.fqbean.natureOfAccident}"
 list="#{'GRIEVOUS':'GRIEVOUS','MAJOR':'MAJOR','MINOR':'MINOR','COSMETIC':'COSMETIC' }">
</s:select>
