...
<form name="quoteForm" action="UpdateQuote" method="post">
 <table align="center" border="1px" style="border-collapse: collapse;">
			       ...
			       <c:forEach var="listElement" items="${viewQuote}">
			       		<tr>
			       				
			       				<td><input type="checkbox" value="${listElement.proposal_id}" name="updateQuote"></td>
			        ...
			        <tr>
			        <td><input type="submit" value="Update Quote" /></td>
