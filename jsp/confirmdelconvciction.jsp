...
<div id="global">
<s:form action="ConfirmConvictiondelete">
 <jsp:useBean id="cnbean" class="com.tcs.ilp.model.FqConvictionhistory" scope="request" />
<table>
<tr><th>Conviction Id</th><td><jsp:getProperty name="cnbean" property="convictionHistoryId"/></td></tr>
<tr><th>User Id</th><td> ${cnbean.fqUser.userId }</td></tr>

<tr><th>Nature Of Conviction</th><td><jsp:getProperty name="cnbean" property="natureOfConviction"/></td></tr>
<tr><th>Date Of Conviction</th><td><jsp:getProperty name="cnbean" property="dateOfConviction"/></td></tr>
<tr><th>Comments</th><td><jsp:getProperty name="cnbean" property="comments"/></td></tr>
