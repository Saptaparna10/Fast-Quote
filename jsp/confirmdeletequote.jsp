...
<form name="quoteForm" action="DeleteQuoteConfirm" method="post">
 <table align="center" border="1px" style="border-collapse: collapse;">
			       ...
			       <c:forEach var="listElement" items="${confirmDeleteQuote}">
			       		<tr>
			        ...
			        <tr><td>
			        <input value="Confirm Delete Quote" type="submit">
			        </td>
