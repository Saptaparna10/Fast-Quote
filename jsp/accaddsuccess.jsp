...
<fieldset>
   <legend align="middle"><b> Add Accident Details</b></legend><br>

<p>Accident Details Added Successfully</p>

<jsp:useBean id="result1" class="com.tcs.ilp.model.FqAccidenthistory" scope="request" />
<table>
<tr><th>Accident Id</th><td><jsp:getProperty name="result1" property="accidentHistoryId"/></td></tr>
<tr><th>User Id</th><td> ${result1.fqUser.userId }</td></tr>
<th>Vehicle Id</th><td> ${result1.fqVehicle.vehicleId }</td></tr>
<tr><th>Nature Of Accident</th><td><jsp:getProperty name="result1" property="natureOfAccident"/></td></tr>
<tr><th>Date Of Accident</th><td><jsp:getProperty name="result1" property="dateOfAccident"/></td></tr>
<tr><th>Comments</th><td><jsp:getProperty name="result1" property="comments"/></td></tr>
</table>
